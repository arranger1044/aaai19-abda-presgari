  ...
  \end{minipage}\hfill\begin{minipage}[t]{0.4\linewidth}
    ...
    \raggedleft\begin{minipage}[t]{.9\linewidth}
      ...
      {\textbf{1b.} \htt[lacamlilac]{\textbf{\emph{infer likelihood
              models}}}\\[-2pt]}
      {\textbf{1c.}\hspace{1pt} \htt[lacamlilac]{\textbf{\emph{infer dependencies}}}\\[5pt]}
...
\begin{frame}[t, htt=bgrey2]
  ...
  \end{minipage}\hfill\begin{minipage}[t]{0.4\linewidth}
    ...
    \raggedleft\begin{minipage}[t]{.9\linewidth}
      ...
      {\textbf{1b.} \htt[lacamlilac]{\textbf{\emph{infer likelihood
              models}}}\\[-2pt]}
      {\textbf{1c.}\hspace{1pt} \htt[lacamlilac]{\textbf{\emph{infer
              dependencies}}}\\[-2pt]}
...
\begin{frame}[t, htt=bgrey2]
  ...
  \end{minipage}\hfill\begin{minipage}[t]{0.6\linewidth}
    ...
    a \htt[pink2]{\textbf{\emph{global level}}}
    \hspace{-70pt}\comment[\normalsize]{modeling dependencies among RVs}{}\\
    a \htt[gold2]{\textbf{\emph{local level}}}
...
\begin{frame}[t, htt=bgrey2]
  ...
  \end{minipage}\begin{minipage}[t]{0.35\linewidth}
    \vspace{20pt}
    \raggedright
    The \htt[pink2]{\emph{\textbf{global level}}} comprises a
